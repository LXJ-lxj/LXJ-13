package com.example.sso.cross.domain.www.x.com;
...
public class LoginController {
    ...
    public RespMessage doLogin(String username, String password) {
        ...
        if (ok) {
            ...
            Map<String, String> targetCookieA = this.buildCookieMap("http://www.a.com:8080/a/addCookie");

            // 向www.b.com服务器发送增加cookie
            Map<String, String> targetCookieB = this.buildCookieMap("http://www.b.com:8080/b/addCookie");
